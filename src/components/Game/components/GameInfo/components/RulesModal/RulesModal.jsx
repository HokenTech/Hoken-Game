          ...
          <div className="RulesModal">
            ...
            <ul>
              <li>
                ...
                <div>Cards have two attributes:</div>
                <ol>
                  <li>Power: 1, 2, or 3</li>
                  <li>Color: Green, Red, or Blue</li>
                </ol>
                <div>There are also 2 special cards:</div>
                <ol>
                  <li>Caparezza card voids all results in a round</li>
                  <li>Calvario card has a power of 5, but no elemental compatibility bonus</li>
                </ol>
              </li>
              ...
              <li><div>Each round, players pick a card. Picks are revealed simultaneously.</div>
                ...
                <dl>
                  ...
                  <dd><p className="calculation1"><span className="power">Attack Power</span><span className="plus">+</span><span className="bonus">Color Compatibility Bonus</span></p></dd>
                </dl>
                <div className="calculations">
                  ...
                  <div className="calculation3">
                    <div className="description">
                      <div>Color Compatibility Bonus</div>
                      <div>Player will gain 1 extra score when the player card's color type is stronger than the opponent's (Red > Green > Blue > Red > etc.). For Special Card 2 (Calvario), no Color Compatibility Bonus is added</div>
                    </div>
                  </div>
                  <div className="calculation4">
                    <div className="description">
                      <div>Special Card 1 (Caparezza)</div>
                      <div>This special 0 Attack Power card voids all results in a round</div>
                    </div>
                  </div>
                  <div className="calculation5">
                    <div className="description">
                      <div>Special Card 2 (Calvario)</div>
                      <div>This special 5 Attack Power card removes color compatibility bonus in a round</div>
                    </div>
                  </div>
                </div>
